...
-- =============================================================================
-- Flyway migration: creates all tables, enums, indexes, and constraints.
...
-- 3. categories
-- =============================================================================
-- Granular request types. Many categories map to one department.
-- Admin creates/edits categories at runtime — no code changes needed.
CREATE TABLE categories (
    ...
    CONSTRAINT fk_categories_department FOREIGN KEY (department_id)
...
CREATE TABLE service_requests (
    ...
    CONSTRAINT fk_requests_department FOREIGN KEY (department_id)
        REFERENCES departments (id),
    CONSTRAINT fk_requests_location FOREIGN KEY (location_id)
        REFERENCES locations (id),
    CONSTRAINT fk_requests_requester FOREIGN KEY (requester_id)
        REFERENCES users (id),
    CONSTRAINT fk_requests_agent FOREIGN KEY (assigned_agent_id)
        REFERENCES users (id),
...
CREATE TABLE status_history (
    ...
    CONSTRAINT fk_status_history_changed_by FOREIGN KEY (changed_by)
        REFERENCES users (id),
    CONSTRAINT fk_status_history_from_agent FOREIGN KEY (from_agent_id)
        REFERENCES users (id),
    CONSTRAINT fk_status_history_to_agent FOREIGN KEY (to_agent_id)
        REFERENCES users (id)
);
...
-- 8. sla_policies
-- =============================================================================
-- One active policy per (category, priority) combination.
CREATE TABLE sla_policies (
    ...
    CONSTRAINT fk_sla_policies_category FOREIGN KEY (category_id)
        REFERENCES categories (id),
...
-- =============================================================================
-- No UPDATE or DELETE permitted — enforced at application layer and DB level.
...
-- =============================================================================
-- The application user (servicehub_app) can only INSERT and SELECT on audit_logs.
-- This prevents any accidental or malicious mutation of the audit trail.
